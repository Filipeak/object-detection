...
def run_face_recognition():
    ...
    while True:
        ...
        small_frame = cv2.resize(img, (0, 0), fx=(1 / IMAGE_DOWNSCALE_FACTOR), fy=(1 / IMAGE_DOWNSCALE_FACTOR))
        ...
        for (top, right, bottom, left), name in zip(face_locations, face_names):
            ...
            cv2.rectangle(img, (left, bottom - 35), (right, bottom), RECTAGLE_COLOR_BGR, cv2.FILLED)
            cv2.putText(img, name, (left + 6, bottom - 6), TEXT_FONT, 1, TEXT_COLOR_BGR, 1)
